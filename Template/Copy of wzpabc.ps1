function init-home{
    begin{
     ...
     $res= Invoke-Sqlcmd -ServerInstance . -Database wzpabc  -Query "$csql"	|Sort-Object -Property DESC -Descending
     $category=''
     $archive=''
     }
     ...
     @(
        ...
        #,'</ul>                                                              '
          ...
          @(
            ...
            ,'<ul>                                                               '
            , $category   
            ,'</ul>                                                              ' ) |Out-File 'sidebartop.html' -Encoding utf8    
            
            
              @( ,'<ul>                                                               '
            , $archive   
            ,'</ul>                                                           '
        )               |Out-File 'sidebartop1.html' -Encoding utf8       
